...
export default function RedTeamLogsPage() {
  return (
    <div className="space-y-6">
      <PageHeader
        title="Red Team Logs"
        description="Security red teaming logs and vulnerability assessments"
      />
      
      <div className="rounded-lg border border-[var(--border)] bg-[var(--night-light)] p-8">
        <div className="flex flex-col items-center justify-center py-12 text-center">
          <AlertOctagon className="h-16 w-16 text-[var(--tropical-indigo)] mb-4" />
