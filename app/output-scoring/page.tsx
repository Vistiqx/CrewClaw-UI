...
export default function OutputScoringPage() {
  return (
    <div className="space-y-6">
      <PageHeader
        title="Output Scoring"
        description="AI output quality scoring and evaluation metrics"
      />
      
      <div className="rounded-lg border border-[var(--border)] bg-[var(--night-light)] p-8">
        <div className="flex flex-col items-center justify-center py-12 text-center">
          <Star className="h-16 w-16 text-[var(--tropical-indigo)] mb-4" />
