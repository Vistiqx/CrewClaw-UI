...
export default function RegressionTestsPage() {
  return (
    <div className="space-y-6">
      <PageHeader
        title="Regression Tests"
        description="Automated regression testing and quality assurance"
      />
      
      <div className="rounded-lg border border-[var(--border)] bg-[var(--night-light)] p-8">
        <div className="flex flex-col items-center justify-center py-12 text-center">
          <RotateCcw className="h-16 w-16 text-[var(--tropical-indigo)] mb-4" />
